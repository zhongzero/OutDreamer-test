...
try:
    import torch_npu
    from outdreamer.npu_config import npu_config, set_run_dtype
    from outdreamer.acceleration.parallel_states import get_sequence_parallel_state, hccl_info
    from outdreamer.acceleration.communications import all_to_all_SBH
except:
    torch_npu = None
    npu_config = None
    set_run_dtype = None
    from outdreamer.utils.parallel_states import get_sequence_parallel_state, nccl_info
    from outdreamer.utils.communications import all_to_all_SBH
